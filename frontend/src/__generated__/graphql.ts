...
export type BaseDirectoryQuery = { __typename?: 'Query', baseDirectory: { __typename?: 'Directory', id: string, name: string, files: Array<{ __typename?: 'File', id: string, name: string, contents: string }>, directories: Array<{ __typename?: 'Directory', id: string, name: string, files: Array<{ __typename?: 'File', id: string, name: string }> }> } };
